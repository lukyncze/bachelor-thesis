...
% přidat info o předávání vlastností dolů i nahoru ve stromě
% chybí informace o tom, že je nutné komponenty importovat
...
function MyComponent() \{
  ...
  return (
    <div>
      \{loaded ? 
        <ChildComponent color=\{'red'\} width=\{100\} heigth=\{100\} /> 
        : 'Loading ...'\}
    </div>
  );
\}
