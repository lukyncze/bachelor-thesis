...
V~rámci komponenty naprogramujeme vnořené komponenty pro zadání vstupního textu, výběr jazyka a~zobrazení výsledku.
...
Do JSX přidáme form značku s~\emph{onSubmit} atributem, kterému předáme funkci \emph{handleSubmit} z~React Hook Form. Do \emph{handleSubmit} pak vložíme vstup \emph{handleFormSubmit} v~rámci nějž získáme aktuální hodnoty formuláře. 
...
\begin{figure}[htb]
	\centering
		\includegraphics[width=.9\textwidth]{images/HintBoxes.jpg}
...
\begin{figure}[htb]
	\centering
		\includegraphics[width=.5\textwidth]{images/GuessedCountriesList.jpg}
