...
V~anonymní funkci posléze změníme stav pomocí \emph{isOpen} na opačnou hodnotu. Abychom předešli event bubblingu, v~anynomní obslužné funkci zavoláme \emph{event.stopPropagation()}.
