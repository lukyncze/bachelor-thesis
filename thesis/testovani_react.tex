...
Poté definujeme a inicializujeme ostatní stavy komponenty. Funkce handleGuessButtonClick vyvolá obslužnou funkci handleEvaluateGuessAndUpdateState v rodičovské komponentě a zavolá funkci handleChangeSelectedGuess.
...
Funkce handleKeyDown umožní uživateli interagovat s podmenu díky klávesnici.
