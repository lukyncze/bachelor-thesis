...
Funkce \emph{getAllCountries} využije převzatý requestHandler a knihovnu \emph{axios}, které pak umožní otypování příchozí odpovědi. Po ošetření chyb aktualizujeme patřičné stavy, které následně z hooku vrátíme. 
