...
V této sekci vytvoříme webovou hru, kde cílem uživatele bude uhádnout název státu na základě poskytnutých nápovědí. Práci si zjednodušíme za pomoci externích knihoven a služeb.
...
Pokud prohlížeč uživatele podporuje emojis a webové fonty, zavoláním funkce polyfillCountryFlagEmojis přes metodu usePolyfill knihovna přidá webové fonty Twemoji Country Flags do HTML hlavičky.
Aby se programaticky přidané fonty použily, nesmíme zapomenout nastavit font-family pravidlo v rámci CSS stylů.
