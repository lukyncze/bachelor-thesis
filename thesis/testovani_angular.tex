...
Pokud prohlížeč uživatele podporuje emojis a webové fonty, zavoláním funkce \emph{polyfillCountryFlagEmojis} přes metodu \emph{usePolyfill} knihovna přidá webový font Twemoji Country Flags do HTML hlavičky.
