...
\autor{Jméno a příjmení, příp. s titulem}
\vedouci{Jméno a příjmení vedoucího vč. titulů}
\nazev{Název práce česky}
\nazevanglicky{Název práce anglicky}
\rok{2023}   % pozor, musi byt rok obhajoby, nikoliv rok, kdy byla prace vytisknuta
\typprace{Bakalářská práce}    % Bakalářská práce, Diplomová práce, Rigorózní práce, Disertační práce


% Dále použijte to, co odpovídá vašemu studijnímu programu, zbývající zakomentujte:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%POKUD STUDUJETE st. program Moderní informatika:
\studijniprogram{Moderní informatika}									%studijni program
\studijnispec{Informační a komunikační technologie}		%specializace (zatím je v programu jen jedna)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%POKUD STUDUJETE st. program Informatika:
%\studijniprogram{Informatika}		%zadejte pouze studijní program, tento není členěn na obory ani specializace

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%POKUD STUDUJETE st. program Aplikovaná informatika:
%\studijniprogram{Aplikovaná informatika}	
%\studijniobor{Aplikovaná informatika}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%POKUD STUDUJETE st. program Informatika a angličtina:
%\studijniprogram{Informatika a angličtina}	%zadejte pouze studijní program, tento není členěn na obory ani specializace

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%POKUD STUDUJETE něco jiného, zvolte, změňte a doplňte podle potřeby.
