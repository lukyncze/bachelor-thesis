...
Framework Angular je velice robustní framework s mnoha funkcemi, které jsou zabudovány přímo do frameworku. 
...
Vývojáři mají možnost vybrat si z mnoha knihoven a nástrojů, které využijí při vývoji. 
Toto může být bráno i negativně, protože vývojáři musí mít přehled o balíčcích a nástrojích, které mohou použít. 
V důsledku pak může být vývoj aplikace složitější a vývojář rovněž vždy nemusí využít vhodné postupy. 
