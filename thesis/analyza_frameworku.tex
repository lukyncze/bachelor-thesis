...
Komponenta potřebuje stavy k tomu, aby si dokázala zapamatovat.\cite{reactbanks,react}

\subsubsection{Hooky}
% Pro správu stavů třídních komponent sloužily vlastnosti a metody dané třídy. Od verze Reactu 16.8.0 přibyly tzv. Hooks, díky kterým je možné spravovat stav i ve funkčních komponentách.\cite{reactgithub}
