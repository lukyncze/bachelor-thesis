...
Začneme návrhem aplikace, kterou posléze implementujeme pomocí vybraných frameworků. 
...
Jedlotlivé komponenty následně poslouží k porovnání přístupu a implementace jednolivých nástrojů.
