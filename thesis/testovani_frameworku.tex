...
Podmíněné vykreslení frameworku v rámci šablony se díky syntaxi jevilo jako nejintuitivnější. 
...
Na druhou stranu Angular vyžaduje větší množství konfigurace a implementace je oproti dalším dvěma frameworkům nejdelší a nejsložitější. 
...
Implementace v Reactu ukázala jeho silné stránky v podobě nejlépe propracovaných knihoven a celkově ekosystému kolem něj. 
...
% Svelte:
% + nejrychlejší hot-reload při vývoji
